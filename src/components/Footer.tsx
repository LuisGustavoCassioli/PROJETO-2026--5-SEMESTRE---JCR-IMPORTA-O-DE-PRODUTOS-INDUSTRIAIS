    ...
    return (
        <footer className="footer">
                ...
                <div className="container footer-grid">
                    ...
                    <div className="footer-brand">
                        ...
                        <div className="footer-contact-inline">
                            <a href="tel:+551120841083"><Phone size={13} /> (11) 2084-1083</a>
                            <a href="mailto:contato@jcrprodutosindustriais.com.br"><Mail size={13} /> contato@jcrprodutosindustriais.com.br</a>
                        </div>
                    </div>
                    ...
                    <div className="footer-col">
                        ...
                        <ul>
                            ...
                            <li><Link to="/politica-de-cookies">Políticas de Cookie</Link></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div className="footer-address-bar">
                <div className="container footer-address-inner">
                    <span><MapPin size={13} /> Av. Sapopemba, 667 - Vila Regente Feijó, São Paulo - SP, 03346-100</span>
                </div>
            </div>

            <div className="footer-bottom">
                <div className="container footer-bottom-inner">
                    <p>© {year} JCR Importação de Produtos Industriais. Todos os direitos reservados.</p>
                </div>
            </div>
